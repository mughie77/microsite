...
$password = null; // Initialize to null
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true && isset($_POST['title'])) {
    ...
    $new_config['theme'] = $_POST['theme'] ?? 'style.css';
...
$config = array_merge([
    ...
    'theme' => 'style.css', // Default to futuristic
    'colors' => [
        'background' => '#000000',
        'accent' => '#00faff',
    ],
                ...
                <div class="site-settings">
                     <div class="form-group">
                        ...
                        <select id="theme" name="theme">
                            <option value="style.css" <?php echo ($config['theme'] === 'style.css') ? 'selected' : ''; ?>>Futuristic</option>
                            <option value="modern.css" <?php echo ($config['theme'] === 'modern.css') ? 'selected' : ''; ?>>Modern</option>
                        </select>
                    </div>
                     <div class="form-group">
                    ...
                    <?php foreach ($config['menu'] as $index => $item): ?>
                        <div class="menu-item" data-index="<?php echo $index; ?>">
                            ...
                            <div class="menu-item-fields">
                                ...
                                <div class="form-group">
                                    <label>Type:</label>
                                    <select name="menu[<?php echo $index; ?>][type]">
                                        <option value="link" <?php echo ($item['type'] === 'link') ? 'selected' : ''; ?>>Link</option>
                                        <option value="modal" <?php echo ($item['type'] === 'modal') ? 'selected' : ''; ?>>Modal</option>
                                    </select>
                                </div>
